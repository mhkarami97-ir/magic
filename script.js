...
function load() {
  let urls = [
    {
      url: "https://api.github.com/repos/mhkarami97-ir/travel/contents/_posts",
      name: "travel",
      persianTxt: "بیا با هم بریم سفر",
      id: 1,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/video/contents/_posts",
      name: "video",
      persianTxt: "یه فیلم با هم ببینیم",
      id: 2,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/book/contents/_posts",
      name: "book",
      persianTxt: "کتاب بهترین رفیق تنهایی آدمه",
      id: 3,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/music/contents/_posts",
      name: "music",
      persianTxt: "خرم آن نغمه که مردم بسپارند به یاد",
      id: 4,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/trip/contents/_posts",
      name: "trip",
      persianTxt: "مجازی سفر کن",
      id: 5,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/trick/contents/_posts",
      name: "trick",
      persianTxt: "یه نکته کاربردی که ممکنه به‌دردت بخوره",
      id: 6,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/blog/contents/_posts",
      name: "blog",
      persianTxt: "وقت یه درس تخصصی هستش",
      id: 7,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/link/contents/_posts",
      name: "link",
      persianTxt: "بریم تو دنیای اینترنت غرق بشیم",
      id: 8,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/poem/contents/_posts",
      name: "poem",
      persianTxt: "دو سه رکعت غزل شاد بخوانم هر روز",
      id: 9,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/sentence/contents/_posts",
      name: "sentence",
      persianTxt: "بعضی وقتا یه جمله می‌تونه آدم رو عوض کنه",
      id: 10,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/experience/contents/_posts",
      name: "experience",
      persianTxt: "خوش بود گر محک تجربه آید به میان",
      id: 11,
    },
    {
      url: "https://api.github.com/repos/mhkarami97-ir/tarfand/contents/_posts",
      name: "tarfand",
